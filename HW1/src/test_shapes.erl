...
test() ->
  ...
  try shapes:shapesArea({shapes, [Square1, Square1, Rectangle_ill]}) of
    _ -> erlang:display("1expected error not thrown!!! Problem in your code")
  catch
  ...
  1.0 = shapes:squaresArea({shapes, [Circle2, Triangle1, Square1]}),
  ...
  2.0 = shapes:squaresArea({shapes, [Square1, Circle2, Rectangle2, Triangle1, Square1]}),
